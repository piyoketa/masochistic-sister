...
- メインフェイズ
    - play-card１枚目：「被虐のオーラ」を「かたつむり」に使用する
        - 検証すべき結果
            - マナが2になる
            - プレイヤーのHPが145
            - かたつむりが「ぬるりと食いつく」の行動をする
            - プレイヤーが攻撃を受けたことにより
                - プレイヤーの手札が6枚になり、状態異常「腐食」とアタック「ぬるりと食いつく」を追加される。使用された「被虐のオーラ」は捨て札に移動する。
...
- メインフェイズ
    ...
    - play-card2枚目：「ぬるりと食いつく」を「触手」に使用する
        - 検証すべき結果
            - マナが2になる
            - 触手に5ダメージ。触手のHPが20になり、Stateが「腐食(1)」になる
            - 手札の「ぬるりと食いつく」が捨て札に移動し、手札が8枚になる
