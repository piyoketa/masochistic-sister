...
export const ACTION_LOG_ENTRY_04_ENEMY_ACT: ActionLogEntrySummary = {
  ...
  animations: [
    // [敵行動ハイライト] 敵の行動を強調
    {
      ...
      snapshot: {player:{hp:145,mana:2},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:6,title:'戦いの準備'},{id:7,title:'日課'}],discardCount:1,exileCount:0,deckCount:4,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:10,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP145/MP2, 手札[天の鎖・天の鎖・戦いの準備・日課], 敵HP[オークランサー=40, かまいたち=20, 鉄花=10, なめくじ=30]
    },
    // [被ダメージ] プレイヤーへの攻撃結果
    {
      waitMs: 0,
    ...
    // [手札追加] 敵攻撃の記憶カード (鈍化・粘液飛ばし) を手札へ
    {
      ...
      metadata: {stage:'card-create',durationMs:1500,enemyId:2,cardTitles:['鈍化','粘液飛ばし'],cards:['鈍化','粘液飛ばし'],cardCount:2,cardIds:[9,10]},
      snapshot: {player:{hp:145,mana:2},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:6,title:'戦いの準備'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'}],discardCount:1,exileCount:0,deckCount:4,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:10,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP145/MP2, 手札[天の鎖・天の鎖・戦いの準備・日課・鈍化・粘液飛ばし], 敵HP[オークランサー=40, かまいたち=20, 鉄花=10, なめくじ=30]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_05_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード移動] 天の鎖 の移動
    {
      ...
      snapshot: {player:{hp:145,mana:2},hand:[{id:1,title:'天の鎖'},{id:6,title:'戦いの準備'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'}],discardCount:1,exileCount:1,deckCount:4,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:10,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP145/MP2, 手札[天の鎖・戦いの準備・日課・鈍化・粘液飛ばし], 敵HP[オークランサー=40, かまいたち=20, 鉄花=10, なめくじ=30]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:9',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:145,mana:1},hand:[{id:1,title:'天の鎖'},{id:6,title:'戦いの準備'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'}],discardCount:1,exileCount:1,deckCount:4,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:10,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP145/MP1, 手札[天の鎖・戦いの準備・日課・鈍化・粘液飛ばし], 敵HP[オークランサー=40, かまいたち=20, 鉄花=10, なめくじ=30]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_06_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 戦いの準備 を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:145,mana:1},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'}],discardCount:2,exileCount:1,deckCount:4,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:10,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP145/MP1, 手札[天の鎖・日課・鈍化・粘液飛ばし], 敵HP[オークランサー=40, かまいたち=20, 鉄花=10, なめくじ=30]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:11',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:145,mana:0},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'}],discardCount:2,exileCount:1,deckCount:4,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:10,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP145/MP0, 手札[天の鎖・日課・鈍化・粘液飛ばし], 敵HP[オークランサー=40, かまいたち=20, 鉄花=10, なめくじ=30]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_09_ENEMY_ACT: ActionLogEntrySummary = {
  ...
  animations: [
    // [敵行動ハイライト] 敵の行動を強調
    {
      ...
      snapshot: {player:{hp:120,mana:0},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'}],discardCount:2,exileCount:1,deckCount:4,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:10,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP120/MP0, 手札[天の鎖・日課・鈍化・粘液飛ばし], 敵HP[オークランサー=40, かまいたち=20, 鉄花=10, なめくじ=30]
    },
    // [被ダメージ] プレイヤーへの攻撃結果
    {
      waitMs: 0,
    ...
    // [手札追加] 敵攻撃の記憶カード (乱れ突き) を手札へ
    {
      ...
      metadata: {stage:'card-create',durationMs:1500,enemyId:1,cardTitles:['乱れ突き'],cards:['乱れ突き'],cardCount:1,cardIds:[11]},
      snapshot: {player:{hp:120,mana:0},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:11,title:'乱れ突き'}],discardCount:2,exileCount:1,deckCount:4,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:10,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP120/MP0, 手札[天の鎖・日課・鈍化・粘液飛ばし・乱れ突き], 敵HP[オークランサー=40, かまいたち=20, 鉄花=10, なめくじ=30]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_14_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    ...
    // [マナ] マナゲージを変化
    {
      ...
      batchId: 'mana:23',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:120,mana:3},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'},{id:5,title:'被虐のオーラ'}],discardCount:3,exileCount:1,deckCount:2,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP120/MP3, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖・被虐のオーラ], 敵HP[オークランサー=40, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [ダメージ演出] 乱れ突き の攻撃結果
    {
      waitMs: 800,
      ...
      snapshot: {player:{hp:120,mana:3},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'},{id:5,title:'被虐のオーラ'}],discardCount:3,exileCount:1,deckCount:2,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'active'},{id:3,hp:30,status:'active'}]}, // 確認: HP120/MP3, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖・被虐のオーラ], 敵HP[オークランサー=40, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [撃破演出] 撃破された敵を退場
    {
      waitMs: 1000,
...
export const ACTION_LOG_ENTRY_15_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード移動] 被虐のオーラ の移動
    {
      ...
      snapshot: {player:{hp:120,mana:3},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'}],discardCount:3,exileCount:1,deckCount:2,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP120/MP3, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖], 敵HP[オークランサー=40, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:27',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:120,mana:2},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'}],discardCount:3,exileCount:1,deckCount:2,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP120/MP2, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖], 敵HP[オークランサー=40, かまいたち=20, 鉄花=0, なめくじ=30]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_16_ENEMY_ACT: ActionLogEntrySummary = {
  ...
  animations: [
    // [敵行動ハイライト] 敵の行動を強調
    {
      ...
      snapshot: {player:{hp:80,mana:2},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'}],discardCount:4,exileCount:1,deckCount:2,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP80/MP2, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖], 敵HP[オークランサー=40, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [被ダメージ] プレイヤーへの攻撃結果
    {
      waitMs: 0,
    ...
    // [手札追加] 敵攻撃の記憶カード (乱れ突き) を手札へ
    {
      ...
      metadata: {stage:'card-create',durationMs:1500,enemyId:0,cardTitles:['乱れ突き'],cards:['乱れ突き'],cardCount:1,cardIds:[12]},
      snapshot: {player:{hp:80,mana:2},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'},{id:12,title:'乱れ突き'}],discardCount:4,exileCount:1,deckCount:2,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP80/MP2, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖・乱れ突き], 敵HP[オークランサー=40, かまいたち=20, 鉄花=0, なめくじ=30]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_17_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 乱れ突き を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:80,mana:2},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'}],discardCount:5,exileCount:1,deckCount:2,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP80/MP2, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖], 敵HP[オークランサー=40, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:32',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:80,mana:1},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'}],discardCount:5,exileCount:1,deckCount:2,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP80/MP1, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖], 敵HP[オークランサー=0, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [ダメージ演出] 乱れ突き の攻撃結果
    {
      waitMs: 600,
      ...
      damageOutcomes: [{damage:10,effectType:'slash'},{damage:10,effectType:'slash'},{damage:10,effectType:'slash'},{damage:10,effectType:'slash'}],
      snapshot: {player:{hp:80,mana:1},hand:[{id:1,title:'天の鎖'},{id:7,title:'日課'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'}],discardCount:5,exileCount:1,deckCount:2,enemies:[{id:0,hp:0,status:'active'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP80/MP1, 手札[天の鎖・日課・鈍化・粘液飛ばし・天の鎖], 敵HP[オークランサー=0, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [撃破演出] 撃破された敵を退場
    {
      waitMs: 1000,
...
export const ACTION_LOG_ENTRY_18_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 日課 を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:80,mana:1},hand:[{id:1,title:'天の鎖'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'}],discardCount:6,exileCount:1,deckCount:2,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP80/MP1, 手札[天の鎖・鈍化・粘液飛ばし・天の鎖], 敵HP[オークランサー=0, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [ドロー] 山札から手札にカードを追加
    {
      waitMs: 0,
...
export const ACTION_LOG_ENTRY_23_ENEMY_ACT: ActionLogEntrySummary = {
  ...
  animations: [
    // [敵行動ハイライト] 敵の行動を強調
    {
      ...
      snapshot: {player:{hp:75,mana:0},hand:[{id:1,title:'天の鎖'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'},{id:8,title:'再装填'},{id:3,title:'天の鎖'}],discardCount:6,exileCount:1,deckCount:0,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP75/MP0, 手札[天の鎖・鈍化・粘液飛ばし・天の鎖・再装填・天の鎖], 敵HP[オークランサー=0, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [被ダメージ] プレイヤーへの攻撃結果
    {
      waitMs: 0,
    ...
    // [手札追加] 敵攻撃の記憶カード (腐食・酸を吐く) を手札へ
    {
      ...
      metadata: {stage:'card-create',durationMs:1500,enemyId:3,cardTitles:['腐食','酸を吐く'],cards:['腐食','酸を吐く'],cardCount:2,cardIds:[13,14]},
      snapshot: {player:{hp:75,mana:0},hand:[{id:1,title:'天の鎖'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'},{id:8,title:'再装填'},{id:3,title:'天の鎖'},{id:13,title:'腐食'},{id:14,title:'酸を吐く'}],discardCount:6,exileCount:1,deckCount:0,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP75/MP0, 手札[天の鎖・鈍化・粘液飛ばし・天の鎖・再装填・天の鎖・腐食・酸を吐く], 敵HP[オークランサー=0, かまいたち=20, 鉄花=0, なめくじ=30]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_25_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 再装填 を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:75,mana:3},hand:[{id:1,title:'天の鎖'},{id:9,title:'鈍化'},{id:10,title:'粘液飛ばし'},{id:2,title:'天の鎖'},{id:3,title:'天の鎖'},{id:13,title:'腐食'},{id:14,title:'酸を吐く'},{id:4,title:'被虐のオーラ'},{id:6,title:'戦いの準備'}],discardCount:1,exileCount:1,deckCount:4,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP75/MP3, 手札[天の鎖・鈍化・粘液飛ばし・天の鎖・天の鎖・腐食・酸を吐く・被虐のオーラ・戦いの準備], 敵HP[オークランサー=0, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [ドロー] 山札から手札にカードを追加
    {
      waitMs: 0,
...
export const ACTION_LOG_ENTRY_26_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 乱れ突き を捨て札へ移動
    {
      ...
      metadata: {stage:'card-trash',cardId:11,cardTitle:'乱れ突き'},
      snapshot: {player:{hp:75,mana:2},hand:[{id:9,title:'鈍化'},{id:13,title:'腐食'},{id:5,title:'被虐のオーラ'},{id:12,title:'乱れ突き'},{id:7,title:'日課'},{id:14,title:'酸を吐く'},{id:1,title:'天の鎖'},{id:10,title:'粘液飛ばし'}],discardCount:2,exileCount:1,deckCount:4,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:20,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'active'}]}, // 確認: HP75/MP2, 手札[鈍化・腐食・被虐のオーラ・乱れ突き・日課・酸を吐く・天の鎖・粘液飛ばし], 敵HP[オークランサー=0, かまいたち=20, 鉄花=0, なめくじ=30]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:48',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:75,mana:1},hand:[{id:9,title:'鈍化'},{id:13,title:'腐食'},{id:5,title:'被虐のオーラ'},{id:12,title:'乱れ突き'},{id:7,title:'日課'},{id:14,title:'酸を吐く'},{id:1,title:'天の鎖'},{id:10,title:'粘液飛ばし'}],discardCount:2,exileCount:1,deckCount:4,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:0,status:'defeated'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'escaped'}]}, // 確認: HP75/MP1, 手札[鈍化・腐食・被虐のオーラ・乱れ突き・日課・酸を吐く・天の鎖・粘液飛ばし], 敵HP[オークランサー=0, かまいたち=0, 鉄花=0, なめくじ=30]
    },
    // [ダメージ演出] 乱れ突き の攻撃結果
    {
      waitMs: 800,
      ...
      snapshot: {player:{hp:75,mana:1},hand:[{id:9,title:'鈍化'},{id:13,title:'腐食'},{id:5,title:'被虐のオーラ'},{id:12,title:'乱れ突き'},{id:7,title:'日課'},{id:14,title:'酸を吐く'},{id:1,title:'天の鎖'},{id:10,title:'粘液飛ばし'}],discardCount:2,exileCount:1,deckCount:4,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:0,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:30,status:'escaped'}]}, // 確認: HP75/MP1, 手札[鈍化・腐食・被虐のオーラ・乱れ突き・日課・酸を吐く・天の鎖・粘液飛ばし], 敵HP[オークランサー=0, かまいたち=0, 鉄花=0, なめくじ=30]
    },
    // [撃破演出] 撃破された敵を退場
    {
      waitMs: 1000,
