...
export const ACTION_LOG_ENTRY_14_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] たいあたり を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:100,mana:4},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:9,title:'腐食'},{id:10,title:'酸を吐く'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:13,title:'粘液飛ばし'},{id:5,title:'被虐のオーラ'}],discardCount:4,exileCount:0,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:25,status:'active'},{id:3,hp:10,status:'active'}]}, // 確認: HP100/MP4, 手札[天の鎖・天の鎖・腐食・酸を吐く・天の鎖・疼き・鈍化・粘液飛ばし・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=25, かたつむり=10]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:26',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:100,mana:3},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:9,title:'腐食'},{id:10,title:'酸を吐く'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:13,title:'粘液飛ばし'},{id:5,title:'被虐のオーラ'}],discardCount:4,exileCount:0,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:25,status:'active'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP100/MP3, 手札[天の鎖・天の鎖・腐食・酸を吐く・天の鎖・疼き・鈍化・粘液飛ばし・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=25, かたつむり=0]
    },
    // [ダメージ演出] たいあたり の攻撃結果
    {
      waitMs: 0,
      ...
      snapshot: {player:{hp:100,mana:3},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:9,title:'腐食'},{id:10,title:'酸を吐く'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:13,title:'粘液飛ばし'},{id:5,title:'被虐のオーラ'}],discardCount:4,exileCount:0,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:25,status:'active'},{id:3,hp:0,status:'active'}]}, // 確認: HP100/MP3, 手札[天の鎖・天の鎖・腐食・酸を吐く・天の鎖・疼き・鈍化・粘液飛ばし・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=25, かたつむり=0]
    },
    // [撃破演出] 撃破された敵を退場
    {
      waitMs: 1000,
...
export const ACTION_LOG_ENTRY_15_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 酸を吐く を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:100,mana:3},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:9,title:'腐食'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:13,title:'粘液飛ばし'},{id:5,title:'被虐のオーラ'}],discardCount:5,exileCount:0,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:25,status:'active'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP100/MP3, 手札[天の鎖・天の鎖・腐食・天の鎖・疼き・鈍化・粘液飛ばし・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=25, かたつむり=0]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:30',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:100,mana:2},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:9,title:'腐食'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:13,title:'粘液飛ばし'},{id:5,title:'被虐のオーラ'}],discardCount:5,exileCount:0,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:20,status:'active'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP100/MP2, 手札[天の鎖・天の鎖・腐食・天の鎖・疼き・鈍化・粘液飛ばし・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=20, かたつむり=0]
    },
    // [ダメージ演出] 酸を吐く の攻撃結果
    {
      waitMs: 0,
...
export const ACTION_LOG_ENTRY_16_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 粘液飛ばし を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:100,mana:2},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:9,title:'腐食'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'}],discardCount:6,exileCount:0,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:20,status:'active'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP100/MP2, 手札[天の鎖・天の鎖・腐食・天の鎖・疼き・鈍化・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=20, かたつむり=0]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:33',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:100,mana:1},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:9,title:'腐食'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'}],discardCount:6,exileCount:0,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP100/MP1, 手札[天の鎖・天の鎖・腐食・天の鎖・疼き・鈍化・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=0, かたつむり=0]
    },
    // [ダメージ演出] 粘液飛ばし の攻撃結果
    {
      waitMs: 0,
      ...
      snapshot: {player:{hp:100,mana:1},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:9,title:'腐食'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'}],discardCount:6,exileCount:0,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'active'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP100/MP1, 手札[天の鎖・天の鎖・腐食・天の鎖・疼き・鈍化・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=0, かたつむり=0]
    },
    // [撃破演出] 撃破された敵を退場
    {
      waitMs: 1000,
...
export const ACTION_LOG_ENTRY_17_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード移動] 腐食 の移動
    {
      ...
      snapshot: {player:{hp:100,mana:1},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'}],discardCount:6,exileCount:1,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP100/MP1, 手札[天の鎖・天の鎖・天の鎖・疼き・鈍化・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=0, かたつむり=0]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:37',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:100,mana:0},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:8,title:'疼き'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'}],discardCount:6,exileCount:1,deckCount:1,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP100/MP0, 手札[天の鎖・天の鎖・天の鎖・疼き・鈍化・被虐のオーラ], 敵HP[オーク=40, オークダンサー=40, 触手=0, かたつむり=0]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_24_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード移動] 疼き の移動
    {
      ...
      snapshot: {player:{hp:60,mana:3},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'},{id:14,title:'乱れ突き'},{id:3,title:'天の鎖'},{id:10,title:'酸を吐く'}],discardCount:0,exileCount:2,deckCount:5,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP60/MP3, 手札[天の鎖・天の鎖・天の鎖・鈍化・被虐のオーラ・乱れ突き・天の鎖・酸を吐く], 敵HP[オーク=40, オークダンサー=40, 触手=0, かたつむり=0]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:47',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:60,mana:2},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'},{id:14,title:'乱れ突き'},{id:3,title:'天の鎖'},{id:10,title:'酸を吐く'},{id:15,title:'乱れ突き'}],discardCount:0,exileCount:2,deckCount:5,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP60/MP2, 手札[天の鎖・天の鎖・天の鎖・鈍化・被虐のオーラ・乱れ突き・天の鎖・酸を吐く・乱れ突き], 敵HP[オーク=40, オークダンサー=40, 触手=0, かたつむり=0]
    },
  ],
}
...
export const ACTION_LOG_ENTRY_25_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 乱れ突き を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:60,mana:2},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'},{id:3,title:'天の鎖'},{id:10,title:'酸を吐く'},{id:15,title:'乱れ突き'}],discardCount:1,exileCount:2,deckCount:5,enemies:[{id:0,hp:40,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP60/MP2, 手札[天の鎖・天の鎖・天の鎖・鈍化・被虐のオーラ・天の鎖・酸を吐く・乱れ突き], 敵HP[オーク=40, オークダンサー=40, 触手=0, かたつむり=0]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:49',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:60,mana:1},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'},{id:3,title:'天の鎖'},{id:10,title:'酸を吐く'},{id:15,title:'乱れ突き'}],discardCount:1,exileCount:2,deckCount:5,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP60/MP1, 手札[天の鎖・天の鎖・天の鎖・鈍化・被虐のオーラ・天の鎖・酸を吐く・乱れ突き], 敵HP[オーク=0, オークダンサー=40, 触手=0, かたつむり=0]
    },
    // [ダメージ演出] 乱れ突き の攻撃結果
    {
      waitMs: 600,
      ...
      damageOutcomes: [{damage:10,effectType:'slash'},{damage:10,effectType:'slash'},{damage:10,effectType:'slash'},{damage:10,effectType:'slash'}],
      snapshot: {player:{hp:60,mana:1},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'},{id:3,title:'天の鎖'},{id:10,title:'酸を吐く'},{id:15,title:'乱れ突き'}],discardCount:1,exileCount:2,deckCount:5,enemies:[{id:0,hp:0,status:'active'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP60/MP1, 手札[天の鎖・天の鎖・天の鎖・鈍化・被虐のオーラ・天の鎖・酸を吐く・乱れ突き], 敵HP[オーク=0, オークダンサー=40, 触手=0, かたつむり=0]
    },
    // [撃破演出] 撃破された敵を退場
    {
      waitMs: 1000,
...
export const ACTION_LOG_ENTRY_26_PLAY_CARD: ActionLogEntrySummary = {
  ...
  animations: [
    // [カード廃棄] 乱れ突き を捨て札へ移動
    {
      ...
      snapshot: {player:{hp:60,mana:1},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'},{id:3,title:'天の鎖'},{id:10,title:'酸を吐く'}],discardCount:2,exileCount:2,deckCount:5,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:40,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP60/MP1, 手札[天の鎖・天の鎖・天の鎖・鈍化・被虐のオーラ・天の鎖・酸を吐く], 敵HP[オーク=0, オークダンサー=40, 触手=0, かたつむり=0]
    },
    // [マナ] マナゲージを変化
    {
      waitMs: 0,
      batchId: 'mana:53',
      metadata: {stage:'mana',amount:-1},
      snapshot: {player:{hp:60,mana:0},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'},{id:3,title:'天の鎖'},{id:10,title:'酸を吐く'}],discardCount:2,exileCount:2,deckCount:5,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:0,status:'defeated'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP60/MP0, 手札[天の鎖・天の鎖・天の鎖・鈍化・被虐のオーラ・天の鎖・酸を吐く], 敵HP[オーク=0, オークダンサー=0, 触手=0, かたつむり=0]
    },
    // [ダメージ演出] 乱れ突き の攻撃結果
    {
      waitMs: 600,
      ...
      damageOutcomes: [{damage:10,effectType:'slash'},{damage:10,effectType:'slash'},{damage:10,effectType:'slash'},{damage:10,effectType:'slash'}],
      snapshot: {player:{hp:60,mana:0},hand:[{id:0,title:'天の鎖'},{id:1,title:'天の鎖'},{id:2,title:'天の鎖'},{id:12,title:'鈍化'},{id:5,title:'被虐のオーラ'},{id:3,title:'天の鎖'},{id:10,title:'酸を吐く'}],discardCount:2,exileCount:2,deckCount:5,enemies:[{id:0,hp:0,status:'defeated'},{id:1,hp:0,status:'active'},{id:2,hp:0,status:'defeated'},{id:3,hp:0,status:'defeated'}]}, // 確認: HP60/MP0, 手札[天の鎖・天の鎖・天の鎖・鈍化・被虐のオーラ・天の鎖・酸を吐く], 敵HP[オーク=0, オークダンサー=0, 触手=0, かたつむり=0]
    },
    // [撃破演出] 撃破された敵を退場
    {
      waitMs: 1000,
