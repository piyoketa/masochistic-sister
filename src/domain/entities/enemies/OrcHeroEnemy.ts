...
import { ConditionalOrcHeroQueue } from '../enemy/actionQueues/ConditionalOrcHeroQueue'
...
export class OrcHeroEnemy extends Enemy {
  constructor(options?: OrcHeroEnemyOptions) {
    ...
    const baseProps = {
      ...
      maxHp: 150,
      currentHp: 150,
      actions: [flurry, new BuildUpAction(), new BattleDanceAction()],
      ...
      actionQueueFactory: () => new ConditionalOrcHeroQueue(),
    }
